<template>
  <el-dialog
    ...
    <el-form ref="formValidate" :model="formValidate" :rules="ruleValidate" label-width="150px">
      ...
      <el-form-item label="启用状态" prop="username" >
        <el-radio v-model="formValidate.radio" label="1">启用</el-radio>
        <el-radio v-model="formValidate.radio" label="2">禁用</el-radio>
      </el-form-item>
      ...
      <el-form-item label="确认密码" prop="confirmPassword" >
        <el-input type="password" v-model="formValidate.confirmPassword" placeholder="输入账号"></el-input>
      </el-form-item>
      <el-form-item label="角色选择" prop="chooseRole" >
        <el-select v-model="formValidate.chooseRole" placeholder="请选择">
          <el-option label="彭于晏" value="peng"></el-option>
          <el-option label="吴彦祖" value="wu"></el-option>
        </el-select>
      </el-form-item>
    ...
    data(){
      ...
      return{
        ...
        ruleValidate: {
          ...
          confirmPassword: [
            { required: true, validator: validatePassCheck,  message: "两次输入密码不一致", trigger: "blur" }
          ],
          chooseRole: [
            {
              required: true,
