    ...
    <div >
      <el-col :span="24">
        <el-card class="box-card">
          ...
          <div class="text item">
            <span class="text_label">活动名称</span>
            {{manager.phone}}
          </div>
          <div class="text item">
            <span class="text_label">活动时间</span>
            {{manager.realname}}
          </div>
          <div class="text item">
            <span class="text_label">是否推荐</span>
            {{manager.status}}
          </div>
          <div class="text item">
            <span class="text_label">是否包邮</span>
            {{manager.comment}}
          </div>
          <div class="text item" style="display: flex;align-items: center">
            <span class="text_label">活动主图</span>
            <el-image
          ...
          <div class="text item" style="display: flex;align-items: center">
            <span class="text_label">活动轮播图</span>
            <div class="block">
              <span class="demonstration" style="padding: 0 200px"></span>
              <el-carousel height="360px" style="width: auto;">
          ...
          <div class="text item">
            <span class="text_label">活动规格</span>
            {{manager.status}}
          </div>
          <div class="text item">
            <span class="text_label">活动详情</span>
            {{manager.comment}}
          </div>
          <el-table
            :data="data"
      ...
      <el-button style="margin:50px auto auto 100px" @click="backButton">返回上一页</el-button>
    </div>
</template>
