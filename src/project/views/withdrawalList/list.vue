...
<!--    分页-->
    <el-col :span="24">
      <div style="width: 95%;margin: 10px auto;">
        <el-button type="primary" icon="el-icon-notebook-2">导出Excel</el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      /*handleRowClick(row) {
        this.$router.push({path: '/withdrawalList/haveCheckShow/' + row.id})
        // this.$router.push({path: '/withdrawalList/toBeCheckShow/' + row.id})
      },*/
      /*handleRowClick(row) {
        // this.$router.push({path: '/withdrawalList/haveCheckShow/' + row.id})
        this.$router.push({path: '/withdrawalList/toBeCheckShow/' + row.id})
