  ...
  <el-row class="page">
    ...
    <el-col :span="24">
      <div style="width: 95%;margin: 10px auto;">
        <el-button icon="el-icon-tickets" @click="exportExcel">导出Excel</el-button>
      ...
      >
        ...
        >
          <template slot-scope="scope">
            <el-button @click.native.prevent="toDetail(scope.row)" type="text" size="small">{{scope.row.phone}}</el-button>
          </template>
        </el-table-column>
        <el-table-column
          prop="nickname"
        ...
        <el-table-column
          ...
          width="200">
          <template slot-scope="scope">
            <el-button @click.stop="modifyMoney" type="text" size="small">修改金额</el-button>
...
<script>
  ...
  export default {
      ...
      return {
        ...
        searchItems: [
          ...
          },
          {
            ...
            key: "orderStatus",
            type: "select",
            displayValue: ["待付款", "代发货", "待收货", "已完成", "已取消", "待评价"],
            value: ["待付款", "代发货", "待收货", "已完成", "已取消", "待评价"]
          }
        ]
      };
    },
    ...
    methods: {
      ...
      // 双击进入详情页面
      /*handleRowClick(row) {
        this.$router.push({path: `/orderManage/show/` + row.id})
      },*/
