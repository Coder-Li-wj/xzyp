<template>
  <div>
    ...
    <el-dialog
      title="评论详情"
      :visible.sync="toViewProps.visible"
      width="30%"
    ...
    <el-button @click="toViewProps.visible = false">取 消</el-button>
    <el-button type="primary" @click="toViewProps.visible = false">确 定</el-button>
  </span>
    </el-dialog>
    ...
    <el-dialog
      title="评论详情"
      :visible.sync="replyProps.visible"
      width="30%"
      :before-close="handleClose">
      ...
      <span slot="footer" class="dialog-footer">
    <el-button @click="replyProps.visible = false">取 消</el-button>
    <el-button type="primary" @click="replyProps.visible = false">确 定</el-button>
  </span>
    </el-dialog>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
     ...
     /* toCreate() {
      ...
      handleClose() {
        this.toViewProps.visible = false
        this.replyProps.visible = false
      },
