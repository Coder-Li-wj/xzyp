<template>
  <div >
    ...
    <el-button style="margin:50px auto auto 100px" type="primary" @click="handleMarkDeal">标记已处理</el-button>
    <el-button style="margin:50px auto auto 0px" @click="backButton">返回上一页</el-button>
  </div>
</template>
