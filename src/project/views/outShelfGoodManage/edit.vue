  ...
  <el-dialog
    ...
    <el-form label-width="150px" v-if="active === 0" :model="form1">
      ...
      <el-form-item label="是否限购">
        <el-radio-group v-model="form1.limitPurchase">
          ...
          <el-input placeholder="请输入数量" v-model="form1.limitPurchaseNumber"
                    v-show="form1.limitPurchase == '是' "></el-input>
        </el-radio-group>
      </el-form-item>
    ...
    <el-form label-width="150px" v-if="active === 2" :model="form3">
      ...
      <el-form-item>
        ...
        <div v-for="(uniqueSpecItem) in form3.specialSpecList" :key="uniqueSpecItem">
          <span style="margin-right: 10%">{{uniqueSpecItem.specificationName}}</span>
          <span style="margin-right: 2%" v-for="(attrItem, attrIndex) in uniqueSpecItem.attrList" :key="attrIndex">
      ...
      <el-form-item>
        <div v-for="generalSpecItem in form3.generalSpecList" :key="generalSpecItem">
          <span style="margin-right: 10%">{{generalSpecItem.specificationName}}</span>
          <span style="margin-right: 2%" v-for="(attrItem, attrIndex) in generalSpecItem.attrList" :key="attrIndex">
                 <el-button style="height: 10%; width: 10%;">
                {{attrItem}}
