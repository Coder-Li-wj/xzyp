...
instance.interceptors.request.use(
  ...
  config => {
    // console.log(config)
    // console.log(JSON.parse(localStorage.getItem('userCache')))
    // if token exist, add Access-Token to request header
    // config.headers['Access-Token'] =  '11'
    // config.headers['id']=11
      config.headers['Access-Token'] = JSON.parse(localStorage.getItem('userCache')).token;
      config.headers['id'] = JSON.parse(localStorage.getItem('userCache')).id;
